...
module.exports = (function() {
  ...
  Instance.prototype.save = function(options, deprecated) {
    ...
    return Promise.bind(this).then(function() {
      ...
      .then(function() {
        ...
        options.shardName = options.shardName || this.getShardName();
  ...
  */
  ...
  /**
   * Get the shardName for this instance
   */
	
  Instance.prototype.getShardName = function() {
    if (this.Model.options.classMethods.shardMapper !== undefined) {
      return this.Model.options.classMethods.shardMapper(this.dataValues[this.Model.options.shardMapperField]);
    }
  }
