  ...
  Instance.prototype.save = function(options, deprecated) {
    ...
    return Promise.bind(this).then(function() {
      ...
      .then(function() {
        ...
        if (self.Model.options.classMethods.shardMapper !== undefined && options.shardName === undefined) {
          options.shardName = self.Model.options.classMethods.shardMapper(this.dataValues[self.Model.options.shardMapperField]);
        }
