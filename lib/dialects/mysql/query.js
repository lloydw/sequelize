...
module.exports = (function() {
  ...
  Query.prototype.runQuery = function(resolve, reject, attempts) {
    var self = this;
    ...
    self.connection.query(self.sql, function(err, results) {
      if (err) {
        ...
        if (err.code === 'ER_LOCK_DEADLOCK' && attempts > 0) {
          self.runQuery(resolve, reject, attempts - 1);
          return;
        }
  ...
  Query.prototype.run = function(sql) {
    ...
    var promise = new Utils.Promise(function(resolve, reject) {
      self.runQuery(resolve, reject, 1);
    });
