...
module.exports = (function() {
  ...
  Model.prototype.sync = function(options) {
    ...
    return Promise.try(function () {
      ...
      return Promise.map(indexes, function (index) {
        index.shardName = options.shardName;
  ...
  Model.prototype.findAll = function(options, queryOptions) {
    ...
    return Promise.bind(this).then(function() {
      ...
      if (this.options.classMethods.shardMapper !== undefined && options.shardName === undefined) {
        options.shardName = this.options.classMethods.databaseMapper(options.where[this.options.shardMapperField]);
      }
